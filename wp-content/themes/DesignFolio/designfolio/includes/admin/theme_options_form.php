	<div class="wrap pc_settings">
		...
		<a href="http://www.presscoders.com/designfolio#buy" target="_blank"><img src="<?php echo PC_THEME_ROOT_URI.'/images/df-free-options-upgrade.png'; ?>" class="alignright" /></a>
		...
		<div id="pc-buttons">
			...
			<a class="button-secondary pc-lower" href="http://www.presscoders.com/designfolio#buy" target="_blank">Upgrade to Pro!</a>
